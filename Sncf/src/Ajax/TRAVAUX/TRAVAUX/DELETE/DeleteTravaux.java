package Ajax.TRAVAUX.TRAVAUX.DELETE;
...
public class DeleteTravaux extends MegaControleur {
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            String code = request.getParameter("CodeTravaux");
            
            commande.Delete(code,"CodeFiche","Travaux");
            
            retourVue(request,response,"/ListeFicheTravail");
