...
public class SortieCalques extends MegaControleur {
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            //INITIALISATION DES LISTES DE GARE SE DES ENTREPRISES ET DES AGENTS
            gare.SetGareSE();
            entreprise.Set();
            agent.Set();
            ...
            GetMessageInformationDAO.getMessageInformation(out,"TexteInformation1",".: SNCF :: CALQUES :: SORTIE :.<br>");
            ...
            SelectDAO.AddSelect(out,"collection",gare.list_CodeGare,gare.list_Gare,1,"onChange=javascript:getHTMLCodeRequestCalques('calques','GetCalques','choix_menu=Null','Champ')");
            
            TOOLS_HTML.getMessage(out,"h2","ENTREPRISE RECEVANT LES CALQUES");
            SelectDAO.AddSelect(out,"entreprise",entreprise.list_CodeEntreprise,entreprise.list_Entreprise,1);
            
            TOOLS_HTML.getMessage(out,"h2","AGENT SORTANT LES CALQUES");
            SelectDAO.AddSelect(out,"agents",agent.list_CodeAgent,agent.list_Nom,1);
