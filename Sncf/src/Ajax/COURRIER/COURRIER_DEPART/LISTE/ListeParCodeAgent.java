...
public class ListeParCodeAgent extends MegaControleur {
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            SelectDAO.AddSelect(out,"Filtre",agent.list_CodeAgent,agent.list_Nom,1,"onChange=javascript:getHTMLCodeRequestCourrier('data','ListAffparCodeAgent','choix_menu=Null','Champ')");
