...
public class GetTexteGestionCourrier extends MegaControleur {
    ...
    throws ServletException, IOException {
            ...
            Onglet_Courrier_Gestion.getOnglet(request,out,"TEXTE","GestionSaveTexte");
            
            out.println("<div id=save>");
            out.println("</div>"); //FIN save
            
            TOOLS_HTML.getMessage(out,"h2","<br><br>Contenu de la lettre :");
