...
public class GetCopieGestionCourrier extends MegaControleur {
    ...
    throws ServletException, IOException {
        ...
        Onglet_Courrier_Gestion.getOnglet(request,out,"COPIE","GestionSaveCopie");
        
        out.println("<div id=save>");
        out.println("</div>"); //FIN save
        
        TOOLS_HTML.getMessage(out,"h2","<br><br>Copie :");
        TextAreaDAO.TextArea(out,"Texte",25,2,"100%",courrier.copie);
