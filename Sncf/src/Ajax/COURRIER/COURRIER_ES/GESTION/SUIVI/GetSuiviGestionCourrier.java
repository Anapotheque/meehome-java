package Ajax.COURRIER.COURRIER_ES.GESTION.SUIVI;
...
public class GetSuiviGestionCourrier extends MegaControleur {
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            Onglet_Courrier_Gestion.getOnglet(request,out,"SUIVI","GestionSaveSuivi");
            
            out.println("<div id=save>");
            out.println("</div>"); //FIN save
            
            TOOLS_HTML.getMessage(out,"h2","<br><br>Demande de suivi :");
