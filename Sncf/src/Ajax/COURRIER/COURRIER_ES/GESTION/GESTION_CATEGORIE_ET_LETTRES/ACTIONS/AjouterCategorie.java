...
public class AjouterCategorie extends MegaControleur {
    ...
    throws ServletException, IOException {
        ...
        if(request.getParameter("Categorie") == null){
            ...
            TOOLS_HTML.getMessage(out,"h2","Nom de la nouvelle catégorie : ");
            InputDAO.AddInput(out,"text","categorie","300px");
            ButtonDAO.AddButtonStyle(out,1,"javascript:getHTMLCodeRequestCourrier('informations','AjouterCategorie','choix_menu=Null','Champ')","Enregistrer");
            ...
            try {
                ...
                courrier.AjoutCategorie(request.getParameter("Categorie"));
