...
public class SearchFmr extends MegaControleur {
    ...
    throws ServletException, IOException {
        ...
        if(choix.equals("null")){
            ...
            //AFFICHAGE
            TOOLS_HTML.Search(request,response,out,"Fmr",listParam,listAff);
            out.close();
            ...
            try {
                result = fmr.Search(request,mot_clef, filtre);
            ...
            if(result){
                ...
                Impression.genererPDF(response, request,fmr.widthsShow,fmr.list_Titre,fmr.list_show,"FMR FILTREES");
                                
                TOOLS_HTML.Show(request,out,"Fmr",fmr.list_Titre,fmr.list_show,fmr.list_CodeFmr,fmr.list_SizeTitre,fmr.list_Titre.size(),true);
            }else
