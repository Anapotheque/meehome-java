var months = new Array("Janvier", "Fevrier", "Mars", "Avril", "Mai", "Juin", "Jeuillet", "Aout", "Septembre", "Octobre", "Novembre", "Decembre");
...
function newCalendar() 
{
	...
	for (var intWeek = 0; intWeek < tableCal.rows.length;  intWeek++)
			 ...
			 intDay++)
	 {
		  ...
		  if(day == daily)
		  {
				document.all.todayday.innerText= "Aujourd'hui: " +  day + "/" + 
