package fr.generali.gfb.monitoring.output;
...
public class XsltFilter implements Filter {
    ...
    public void init(FilterConfig filterConfig) throws ServletException {
        ...
        if (xsltPath == null) {
            ...
            xsltStreamSource = new StreamSource(getClass().getResourceAsStream(
                    "/fr/generali/gfb/monitoring/output/xsl/monitoring.xsl"));
        } else {
            // convert the context-relative path to a physical path name
            String xsltFileName = filterConfig.getServletContext().getRealPath(
                    xsltPath);
        ...
        try {
            ...
            throw new UnavailableException("Init the transformer :: "
                    + e.toString());
        }
