...
public class GenererFichedeRetourCalques extends MegaControleur {
    ...
    throws ServletException, IOException, DocumentException {
        ...
        try {
            ...
            document = GetDeclarationPDF(document, utilisateur,"FicheCalquesRetour");
            
            Paragraph titre = new Paragraph("FICHE DE RETOUR DES CALQUES\n\n\n",FontFactory.getFont(police, 20, Font.BOLD, new Color(0, 0, 0))) ;
            titre.setAlignment(Element.ALIGN_CENTER) ;
            document.add(titre) ;
                                   
            Paragraph corps3 = new Paragraph("Date de retour : "+DataDate.GetDate(),FontFactory.getFont(police, 12, 0, new Color(0, 0, 0))) ;
