...
public class AffaireChoix extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        list1.add("Affaires / N°");
        list1.add("Affaires / Nom");
        ...
        SelectDAO.AddSelect(out,"Filtre",list2,list1,1,"onChange=javascript:getHTMLCodeRequestCourrier('data','RedirectionChoixAffaires','choix_menu=Redirection','Champ')");
