package Ajax.COURRIER.COURRIER_ES.GESTION.PJ;
...
public class GetPJGestionCourrier extends MegaControleur {
    ...
    throws ServletException, IOException {
            ...
            Onglet_Courrier_Gestion.getOnglet(request,out,"PJ","GestionSavePJ");
            
            out.println("<div id=save>");
            out.println("</div>"); //FIN save
            
            TOOLS_HTML.getMessage(out,"h2","<br><br>Pieces Jointes :");
            TextAreaDAO.TextArea(out,"Texte",25,2,"100%",courrier.PJ);
