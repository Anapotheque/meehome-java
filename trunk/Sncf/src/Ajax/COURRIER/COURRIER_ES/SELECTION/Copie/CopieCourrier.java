...
public class CopieCourrier extends MegaControleur {
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            OngletCourrier.getOnglet(request,out,"Copie","EnregistrementCopie");
            out.println("<br>");
            out.println("<div id=save>");
            out.println("</div>"); //FIN save
            
            TextAreaDAO.TextArea(out,"copie",25,0,"100%",courrier.copie);
