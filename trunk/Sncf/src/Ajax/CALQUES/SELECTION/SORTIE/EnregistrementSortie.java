/*
 * EnregistrementSortie.java
 *
 * Created on 28 novembre 2006, 13:16
 */
...
public class EnregistrementSortie extends MegaControleur {
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            for(int i = 0; i < list_Code.size(); i ++)
                calque.Sortie(""+list_Code.get(i),calque.codeAgent,calque.codeEntreprise,DataDate.GetDate());
            ...
            ButtonDAO.AddButtonStyle(out,1,"javascript:getHTMLCodeRequestCalques('calques','GetCalques','null','Champ')","OK");
