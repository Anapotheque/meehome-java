...
public class SearchEntreprisesCalques extends MegaControleur {
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            TOOLS_HTML.getMessage(out,"h2","SELECTIONNEZ UNE ENTREPRISE");
            SelectDAO.AddSelect(out,"entreprise",entreprise.list_CodeEntreprise,entreprise.list_Entreprise,1,"onChange=javascript:getHTMLCodeRequestCalques('Search','AffichageInformationCalquesEntreprises','','Champ')");
