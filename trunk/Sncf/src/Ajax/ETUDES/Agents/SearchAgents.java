...
public class SearchAgents extends MegaControleur {
    ...
    throws ServletException, IOException {
        ...
        if(choix.equals("null")){
            ...
            //AFFICHAGE
            TOOLS_HTML.Search(request,response,out,"Agents",listParam,listAff);
            ...
            try {
                result = agent.Search(mot_clef, filtre);
            ...
            if(result){
                ...
                Impression.genererPDF(response, request,agent.widthsShow,agent.list_TitreShow,agent.list_search,"AGENTS FILTREES");
                
                TOOLS_HTML.Show(request,out,"Agents",agent.list_TitreShow,agent.list_search,agent.list_CodeAgent,agent.list_SizeTitre,agent.list_TitreShow.size(),true);
            }else
