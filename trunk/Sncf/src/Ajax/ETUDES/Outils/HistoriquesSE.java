...
public class HistoriquesSE extends MegaControleur {
    ...
    throws ServletException, IOException {
        ...
        if(choix.equals("Null")){
            ...
            //AFFICHAGE
            TOOLS_HTML.Search(request,response,out,"HistoriquesSE",gare,false);
            out.close();
            
        }
        
        else if(choix.equals("HistoriquesSE")){
            ...
            try {
                result = historique.SetHistorySEGares(codeGare);
            ...
            if(result){
                try {
                    ...
                    Impression.genererPDF(response, request,historique.widthsShowSE,historique.list_TitreSE,historique.list_show,"HISTORIQUE SE "+gare.GetnomGare(""+codeGare));
                ...
                TOOLS_HTML.Show(request,out,historique.list_TitreSE,historique.list_show,historique.list_SizeTitreSE,historique.list_TitreSE.size());
            } else
